<x-layouts>
    ...
    <div class="mx-auto max-w-2xl bg-gray-800/40 p-10 sm:p-12 rounded-2xl border border-white/5 shadow-xl text-center">
        ...
        <div class="mt-10 space-y-5 text-left">
            <div class="flex items-center justify-between p-4 bg-gray-900/50 rounded-xl border border-white/5 hover:border-indigo-500/30 transition-all duration-200">
