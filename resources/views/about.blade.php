<x-layouts>
    ...
    <div class="max-w-4xl mx-auto py-8">
        <div
            class="flex flex-col md:flex-row items-center gap-8 bg-gray-900/50 p-8 rounded-2xl border border-white/10 backdrop-blur-md">

            <div class="shrink-0">
                <img src="{{ asset($profile->avatar) }}" alt="{{ $profile->name }}"
                    class="size-48 rounded-2xl object-cover outline outline-offset-2 outline-indigo-500" />
            </div>
